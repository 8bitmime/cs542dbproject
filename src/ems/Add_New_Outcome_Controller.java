...
public class Add_New_Outcome_Controller {
    ...
    public void getType() throws IOException {
        ...
        String input = outcomeName.getText();
        mainVar.showReportCallSceneWithPassedOutcomeData(input);
